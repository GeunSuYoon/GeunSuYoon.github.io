...
- Phase 1-2: (1) Simple Betch Monitor
	...
	![Phase1-2_SimpleBetchMonitor](/public/img/_src/lecture/lecture_os_01_phase1-2.png)
	- Debugging이 회사에서 끝났다.
	- Resolved limitaions
...
- Phase 1-3: (2) Batch Monitor
	...
	- Still single job, so utilization often bad
		...
		![Phase1-3_BatchMonitor](/public/img/_src/lecture/lecture_os_01_phase1-3.png)
